...
data class Lang(
    ...
    val game__Rules: String,
    val game__References: String,
    ...
    val packer__title: String,
    val packer__Add_game_to_pack: String,
    val packer__Game: String,
    val packer__Add_to_pack: String,
    val packer__Edit: String,
...
private val langs = mapOf(
    ...
    "en" to Lang(
        ...
        packer__title = "Travel Packer",
        packer__Add_game_to_pack = "Add game to pack",
        packer__Game = "Game",
        packer__Add_to_pack = "Add to pack",
        packer__Edit = "Edit",
    ...
    "fr" to Lang(
        ...
        packer__title = "Packer",
        packer__Add_game_to_pack = "Ajouter un jeu au pack",
        packer__Game = "Jeu",
        packer__Add_to_pack = "Ajouter au pack",
        packer__Edit = "Éditer",
